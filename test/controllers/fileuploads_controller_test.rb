...
class FileuploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fileupload" do
    assert_difference('Fileupload.count') do
      post fileuploads_url, params: { fileupload: { content_type: @fileupload.content_type, contents: @fileupload.contents, fname: @fileupload.fname } }
    end
  ...
  test "should update fileupload" do
    patch fileupload_url(@fileupload), params: { fileupload: { content_type: @fileupload.content_type, contents: @fileupload.contents, fname: @fileupload.fname } }
